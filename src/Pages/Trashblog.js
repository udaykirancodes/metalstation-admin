                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Restore Blog</h5>
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={EditBlog}>Restore Blog</button>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    search ? blogs.map((element, index) => {
                                        ...
                                        blogs.map((element, index) => {
                                            return <tr key={index} >
                                                ...
                                                <td className='description'>{element.description}</td>
                                                <td className='image'> <img style={{ height: '80px', width: '150px', borderRadius: '10px' }} src={backendurl + element.img} alt="Blog Image" ></img> </td>
                                                <td><i className="fa-solid fa-trash-can-arrow-up mx-2" role='button' data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={() => { setId(element._id) }}>E</i></td>
                                            </tr>
