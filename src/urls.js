...
export const GetEnquiries = backendurl + 'enquiry/getall'
export const UpdateEnquiry = backendurl + 'enquiry/update'
export const GetAllOrders = backendurl + 'orders/getall'

export const GetUserProfileUrl = backendurl + 'access/profile/'; // + id 
export const GetUserWishList = backendurl + 'access/wishlist/'; // + id 
export const GetUserCartUrl = backendurl + 'access/cart/'; // + id 